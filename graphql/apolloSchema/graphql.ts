...
export type Mutation = {
  ...
  rateModel?: Maybe<Scalars['Boolean']>;
...
export type MutationRateModelArgs = {
  modelSlug?: InputMaybe<Scalars['String']>;
...
export type RateModelMutationVariables = Exact<{
  slug: Scalars['String'];
  score: Scalars['Int'];
}>;


export type RateModelMutation = { __typename?: 'Mutation', rateModel?: boolean | null };
...
export const RateModelDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"RateModel"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"slug"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"score"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"rateModel"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"score"},"value":{"kind":"Variable","name":{"kind":"Name","value":"score"}}},{"kind":"Argument","name":{"kind":"Name","value":"modelSlug"},"value":{"kind":"Variable","name":{"kind":"Name","value":"slug"}}}]}]}}]} as unknown as DocumentNode<RateModelMutation, RateModelMutationVariables>;
